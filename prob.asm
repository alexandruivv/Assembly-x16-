;Ivanov Alexandru
;Grupa 214/1
;Laborator 6 - problema 11: Se dau doua siruri de caractere S1 si S2. Sa se construiasca sirul D ce contine toate elementele din S1 care nu apar in S2.
;Exemplu:
;S1: '+', '4', '2', 'a', '8', '4', 'X', '5'
;S2: 'a', '4', '5'
;D: '+', '2', '8', 'X'
...
start:
    ...
    jcxz Sfarsit        ;cream o bucla pt parcurgere
        Repeta:
			...
			inc bx						;si incrementam bx pentru a insera urmatorul element in d
